...
exports.View = void 0; // the generic type constraints here are gnarly because we need the view to always 
...
var View = /*#__PURE__*/function () {
  function View(parent, model) {
    ...
    this.parent = parent;
    this.model = model; // the elements in the regionsMap
...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this = _super.apply(this, arguments); // create as arrow function to avoid "Cannot read property 'setRandomAge' of undefined"
    ...
    _this.onSetNameClick = function () {
      ...
      var input = _this.parent.querySelector('[data-js="nameField"]'); // need type guard
...
var UserShow = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserShow(parent, model, isDetailPage) {
    var _this;

    _classCallCheck(this, UserShow);

    _this = _super.call(this, parent, model);
    _this.parent = parent;
    _this.model = model;
    _this.isDetailPage = isDetailPage;
    return _this;
  }
  ...
  _createClass(UserShow, [{
    key: "template",
    value: function template() {
      var backLink = this.isDetailPage ? '<div><a href="index.html">&lt; Back</a></div>' : '';
      var header = this.isDetailPage ? '<h1>User Detail</h1>' : '';
      var detailLink = this.isDetailPage ? "User Name: ".concat(this.model.get('name')) : "User Name: <a href=\"/user.html?id=".concat(this.model.get('id'), "\">").concat(this.model.get('name'), "</a>");
      return "\n      <div>\n        ".concat(backLink, "\n        ").concat(header, "\n        <div>").concat(detailLink, "</div>\n        <div>User Age: ").concat(this.model.get('age'), "</div>\n      </div>\n    ");
    }
  }]);
...
var UserEdit = /*#__PURE__*/function (_View_1$View) {
  ...
  _createClass(UserEdit, [{
    key: "onRender",
    value: function onRender() {
      new UserShow_1.UserShow(this.regions.userShow, this.model, true).render();
...
var axios_1 = __importDefault(require("axios")); // use a generic constraint to make sure T has an ID
...
var Attributes = function Attributes(data) {
  ...
  this.data = data; // generic constraint used here. "K" is convention.
...
exports.Attributes = Attributes; // the below is an example that demonstrates how the generic 
...
var Model = /*#__PURE__*/function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; // When using composition we need to create methods that will call the methods 
...
var Eventing_1 = require("./Eventing"); // T is e.g. "User" model, K is e.g. "UserProps" interface
...
var Collection = /*#__PURE__*/function () {
  ...
  } // need getter syntax since the submodules are initialized inline
...
var rootUrl = 'http://localhost:3000/users'; // using inheritance rather than composition here because of the number of different 
...
exports.User = User;
},{"./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/user.ts":[function(require,module,exports) {
"use strict";
...
var userParam = urlParams.get('id') || '1';
var userIdParsed = parseInt(userParam);
var userId = typeof userIdParsed === 'number' ? userIdParsed : 1;
...
},{}]},{},["../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/user.ts"], null)
//# sourceMappingURL=/user.e459c474.js.map